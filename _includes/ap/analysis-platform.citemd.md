...
- ISARIC4C tier 0: (unconsented) prospective clinical data from 215,588 cases
- ISARIC4C tiers 1 and 2: serial multiomic assays from research samples of blood, respiratory secretions, urine, and stool from 2,399 cases
