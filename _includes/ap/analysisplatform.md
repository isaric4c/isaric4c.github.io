...
- ISARIC4C tier 0: (unconsented) prospective clinical data from {!~/Dropbox/6_websites/baillielab.net/docs/img/isaric4c/crf_count.txt!} cases
- ISARIC4C tiers 1 and 2: serial multiomic assays from research samples of blood, respiratory secretions, urine, and stool from {!~/Dropbox/6_websites/baillielab.net/docs/img/isaric4c/multiomics_count.txt!} cases
- COG-UK: (unconsented) summary variant data from COG-UK viral sequencing study is already included for matched patients
- [GenOMICC study](https://genomicc.org/uk) complete data: microarray and whole genome sequence data from {!~/Dropbox/6_websites/baillielab.net/docs/img/isaric4c/genomicc_count.txt!} cases
- PHOSP complete data: follow-up clinical and biological data generated by the Post-Hospitalisation for COVID-19 follow-up study (1071 cases)
...
![Structure of the ISARIC4C Analysis Platform](/Users/jkb/Dropbox/6_websites/baillielab.net/docs/img/isaric4c/i4c-analysis-platform.svg){#fig:structure width=60%}

<!--
![ISARIC4C study](~/Dropbox/6_websites/baillielab.net/docs/img/isaric4c/ISARIC_UKmap.pdf){#fig:map width=50%}
-->
